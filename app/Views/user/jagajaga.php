...
<body>
    ...
    <main>
        <section class="hero-section" id="home">
            ...
            <a class="btn btn-ghost btn-through" href="#form">
                Buku Tamu <span> </a>
        </section>
            ...
            <div class="container">
                <form action="<?= base_url('PostController/store') ?>" method="POST" class="form-container">
                    <div class="container-fluid bg-transparent p-2 rounded" id="box">
                        <h2 class="staggered-rise-in">FORM PENGUNJUNG</h2>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div id="lainnyaFieldsPekerjaan" style="display:none;" class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lainnyaDataPekerjaan"
                                        placeholder="Masukkan Pekerjaan Umum/lainnya Contoh: Petani atau Warga Lokal"
                                        name="lainnyaDataPekerjaan">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="lainnyaFieldsKeperluan" style="display:none;" class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lainnyaDataKeperluan"
                                        placeholder="Masukkan Keperluan Lainnya" name="lainnyaDataKeperluan">
                                </div>
                                <div class="form-group">
